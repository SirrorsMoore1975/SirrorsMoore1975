...
## How To Install Postgres and run in on Linux
There are various tutorial online which help anyone wants to run postgres on their linux machine. Resources like artiles from Digital Ocean are great. However, I find it difficult to obtain an artile that concentrated on Linux. I wrote this artile in [Medium.com](https://medium.com/@chadwickau/how-to-install-postgres-on-linux-5c7e507e0b94) and hope that anyone who might want POSTGRES to run on their Linux machine find helpful.
